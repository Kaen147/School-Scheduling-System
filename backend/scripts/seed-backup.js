...
async function seedDatabase() {
  ...
  try {
    ...
    // Seed Second Year 1st Semester Schedule (4 subjects only for testing)
    const existingScheduleY2S1 = await Schedule.findOne({
      courseId: bsit._id,
      yearLevel: '2',
      semester: '1',
      academicYear: '2025-2026'
    ...
    if (!existingScheduleY2S1) {
      // Get subjects for Year 2 Semester 1 (only 4 subjects)
      ...
      // Assign teachers (avoid conflicts with Year 1 schedule)
      const teacher1 = teachers[0]; // Prof. John Smith
      const teacher2 = teachers[1]; // Ms. Maria Garcia
      const teacher3 = teachers[2]; // Mr. Robert Johnson
      const teacher4 = teachers[3]; // Dr. Sarah Williams

      const scheduleEventsY2S1 = [
        // Monday - Different times/rooms from Year 1 to avoid conflicts
        {
          day: 'Monday',
          startTime: '07:30',
          endTime: '09:30',
          subjectId: webDesign._id,
          subjectName: webDesign.name,
          subjectCode: webDesign.code,
          sessionType: 'lecture',
          room: room201.name, // Different room from Year 1
          assignedTeacher: {
            teacherId: teacher3._id, // Different teacher from Year 1 Monday 7:30
            teacherName: teacher3.getDisplayName()
          }
        },
        {
          ...
          subjectCode: webDesign.code,
          sessionType: 'lab',
          room: compLab2.name, // Different lab from Year 1
          assignedTeacher: {
            teacherId: teacher3._id,
            teacherName: teacher3.getDisplayName()
          }
        ...
        // Tuesday - Different times/rooms from Year 1
        {
          day: 'Tuesday',
          startTime: '07:30',
          endTime: '09:30',
          subjectId: pcAssembly._id,
          subjectName: pcAssembly.name,
          subjectCode: pcAssembly.code,
          sessionType: 'lecture',
          room: room201.name, // Different room
          assignedTeacher: {
            teacherId: teacher1._id, // Teacher 1 is free at this time (Year 1 has teacher2)
            teacherName: teacher1.getDisplayName()
          }
        },
        {
          ...
          subjectCode: pcAssembly.code,
          sessionType: 'lab',
          room: compLab2.name, // Different lab
          assignedTeacher: {
            teacherId: teacher1._id,
            teacherName: teacher1.getDisplayName()
          }
        ...
        // Thursday - Year 1 only has one class, so plenty of room
        {
          day: 'Thursday',
          startTime: '10:30',
          endTime: '13:30',
          subjectId: artApp._id,
          subjectName: artApp.name,
          subjectCode: artApp.code,
          sessionType: 'lecture',
        ...
        // Friday - Year 1 has no classes, so no conflicts
        {
          day: 'Friday',
          startTime: '07:30',
          endTime: '09:30',
          subjectId: dataStructures._id,
          subjectName: dataStructures.name,
          subjectCode: dataStructures.code,
          sessionType: 'lecture',
          room: room201.name,
          assignedTeacher: {
            teacherId: teacher4._id,
      ...
      const newScheduleY2S1 = await Schedule.create({
        ...
        semester: '1',
        academicYear: '2025-2026',
        events: scheduleEventsY2S1,
        isActive: true
      });

      console.log(`   ✅ Year 2 Semester 1 schedule created with ${scheduleEventsY2S1.length} events (4 subjects for testing)\n`);
    } else {
