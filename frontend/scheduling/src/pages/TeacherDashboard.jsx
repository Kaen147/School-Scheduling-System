  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        try {
          const wlRes = await axios.get(`${import.meta.env.VITE_API_URL}/api/workload/teacher/${teacherId}`, { signal });
          if (wlRes && wlRes.data) {
        ...
        if (workloadData && workloadData.totalAssignmentUnits !== undefined) {
          ...
          const offRes = await axios.get(`${import.meta.env.VITE_API_URL}/api/offerings`, { signal });
          ...
          const schedRes = await axios.get(`${import.meta.env.VITE_API_URL}/api/schedules/by-teacher/${teacherId}`, { signal });
  ...
  const handleProfileImageUpload = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/teachers/${user._id}/upload-profile`,
        formData,
        { headers: { "Content-Type": "multipart/form-data" } }
      );

      if (res.data?.imageUrl) {
        setProfileImage(`${import.meta.env.VITE_API_URL}${res.data.imageUrl}`);
      }
    } catch (err) {
