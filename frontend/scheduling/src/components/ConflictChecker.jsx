    ...
    try {
      const conflictChecks = await Promise.all([
        ...
        ...teachers.map(async (teacher) => {
          ...
          try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/workload/check-conflicts`, {
        ...
        ...rooms.map(async (room) => {
          ...
          try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/rooms/check-conflicts`, {
              roomId: room.roomId,
              academicYear,
              semester,
              excludeSubject: subjectId
